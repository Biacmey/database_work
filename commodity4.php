...
<body>
    ...
    <section class="gallery py-md-5 py-4">
        <div class="gallery-inner py-md-5 py-4">
            <h1 class="tittle text-center mb-md-5 mb-4">商品</h1>
            ...
            <ul class="portfolio-area clearfix">
                ...
                $sql = "SELECT * FROM commodity2 INNER JOIN commodity3 ON commodity2.model=commodity3.model ORDER BY sales DESC LIMIT 10";
