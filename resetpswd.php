                ...
                <li>
                    <div class="slider-info">
                        <div class="container" style="padding: 1rem 0 0 0;min-height:700px;">
                            ...
                            if ($row) {
                                $mt = md5($row['account'] . $row['password']);
                                if ($mt == $token) {
                                    if (time() - $row['getpswdctime'] > 30 * 60) {
                                        $msg = '該連結已過期！';
                                    } else {
                                        //重置密碼... 
                                        $msg = "";
                            ?>
                                        <h3>請重新設定密碼</h3>
                                        <hr>新密碼 (至少包含一個大寫字母，且大於6個字，低於20個字)<br>
                                        <form method="post" action="resetpswdac.php" autocomplete="off">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <input type="password" name="passwordConfirm" id="passwordConfirm" class="form-control input-lg" placeholder="Confirm Password" tabindex="1" pattern="(?=.*[A-Z]).[0-9A-Za-z]{5,20}" title="請輸入超過六個字，低於二十個字。要有一個大寫英文字，且不要有特殊符號>_<" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                                            if (!empty($_GET['error'])) {
                                                ...
                                                if ($error == 2) {
                                                    echo "<font color = 'red'>這密碼不就是原本的嗎 Σ(°Д°;</font><br>";
                                                }
                                            }
                                            ?>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="確認更改" class="btn btn-primary btn-block btn-lg" tabindex="3"></div>
                                            </div>
                                        </form>
                            <?php
                                    }
