            ...
            <ul class="rslides" id="slider3">
                <li>
                    <div class="slider-info">
                        <div class="container" style="padding: 1rem 0 0 0;min-height:1250px;">
                            ...
                            $sql = "SELECT SUM(buynumber),SUM(total),name FROM buybuy GROUP BY model,user HAVING user='$user'";
                            $result = $conn->query($sql);
      

                            while ($row  = $result->fetch_assoc()) {
                                $dbname = $row["name"];
                                $dbtobuy = $row["SUM(buynumber)"];
                                $dbtotal = $row["SUM(total)"];
                                

                                echo "<h5>商品名稱: " . $dbname . " 購買數量: " . $dbtobuy . " 此筆金額為: " . $dbtotal . "<hr><br></h5>";
                                $tototal = $tototal + $dbtotal;
                            }
                            echo "<h4> 總金額: " . $tototal . "</h4><br>";
                            ?>
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-md-6">
                                    ...
                                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                                        <input type="submit" name="submot" id="accept" value="確認付款" class="btn btn-primary btn-block btn-lg" tabindex="3">
                                        <input type="hidden" name="amount" value="<?php echo $tototal; ?>">
                                        <input type="hidden" name="cmd" value="_xclick">

                                        <input type="hidden" name="business" value="a0975570853@yahoo.com.tw">
                                ...
                                <div class="col-xs-6 col-md-6">
                                    <form action="cancelbuy.php" method="post">
                                        <input type="submit" name="cancel" id="cancel" value="取消訂單" class="btn btn-primary btn-block btn-lg" tabindex="4">
                                    </form>
                                </div>
                            </div>
                        </div>
